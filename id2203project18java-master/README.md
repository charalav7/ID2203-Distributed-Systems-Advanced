# ID2203 Project 2018 Java Starter Code
...
```
java -jar target/project18-server-1.1-SNAPSHOT-shaded.jar -p 45678
```
...
```
java -jar target/project18-server-1.1-SNAPSHOT-shaded.jar -p 56789 -s <bsip>:<bsport>
```
...
```
java -jar target/project18-client-1.1-SNAPSHOT-shaded.jar -p 56787 -s <bsip>:<bsport>
```
